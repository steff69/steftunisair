...
public class TicketB extends AppCompatActivity {

    private User user;
    private int current_position_in_list;

    ImageView ticket_b_right, ticket_b_left;
    TextView ticket_b_label, ticket_b_departure_country, ticket_b_departure_city, ticket_b_flight_for_country, ticket_b_flight_for_city,
            ticket_b_passenger_name_surname, ticket_b_passenger_nationality, ticket_b_departure_date, ticket_b_departure_gate_closes,
            ticket_b_passport_number, ticket_b_departure_time;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ticket_b);
        ...
        ticket_b_label = findViewById(R.id.ticket_b_label);
        ticket_b_label.setText(String.valueOf(uniqueCheckInTicket.get(current_position_in_list).getTicketReservationID()));

        ticket_b_departure_country = findViewById(R.id.ticket_b_departure_country);
        ...
        ticket_b_departure_country.setText(departureCountryAndCity[0]);

        ticket_b_departure_city = findViewById(R.id.ticket_b_departure_city);
        ticket_b_departure_city.setText(departureCountryAndCity[1].replace(" ", ""));

        ticket_b_flight_for_country = findViewById(R.id.ticket_b_flight_for_country);
        ...
        ticket_b_flight_for_country.setText(flightForCountryAndCity[0]);

        ticket_b_flight_for_city = findViewById(R.id.ticket_b_flight_for_city);
        ticket_b_flight_for_city.setText(flightForCountryAndCity[1].replace(" ", ""));

        ticket_b_passenger_name_surname = findViewById(R.id.ticket_b_passenger_name_surname);
        ticket_b_passenger_name_surname.setText(uniqueCheckInTicket.get(current_position_in_list).getTicketReservationCheckInUserSurname() + " " + uniqueCheckInTicket.get(current_position_in_list).getTicketReservationCheckInUserName());

        ticket_b_passenger_nationality = findViewById(R.id.ticket_b_passenger_nationality);
        ticket_b_passenger_nationality.setText(uniqueCheckInTicket.get(current_position_in_list).getTicketReservationCheckInUserNationality());

        ticket_b_departure_date = findViewById(R.id.ticket_b_departure_date);
        ticket_b_departure_date.setText(dateAndTime[0]);

        ticket_b_departure_gate_closes = findViewById(R.id.ticket_b_departure_gate_closes);
        ticket_b_departure_gate_closes.setText(String.valueOf(gateCloses) + ":" + departureTimeHourAndMinute[1] + " " + dateAndTime[2]);

        ticket_b_passport_number = findViewById(R.id.ticket_b_passport_number);
        ticket_b_passport_number.setText(uniqueCheckInTicket.get(current_position_in_list).getTicketReservationCheckInUserPassportNumber());

        ticket_b_departure_time = findViewById(R.id.ticket_b_departure_time);
        ticket_b_departure_time.setText(dateAndTime[1].replace(" ", "") + " " + dateAndTime[2]);

        ticket_b_right = findViewById(R.id.ticket_b_next_button);
        ticket_b_left = findViewById(R.id.ticket_b_back_button);

        if(current_position_in_list == 0) {
            ticket_b_left.setVisibility(View.INVISIBLE);
            ticket_b_left.setEnabled(false);
        }

        if((uniqueCheckInTicket.size() > current_position_in_list + 1) == false) {
            ticket_b_right.setVisibility(View.INVISIBLE);
            ticket_b_right.setEnabled(false);
        }

        ticket_b_left.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(TicketB.this, TicketA.class);
        ...
        ticket_b_right.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(TicketB.this, TicketA.class);
                intent.putExtra("user", user);
    ...
    public void onBackPressed(){
        Intent intent = new Intent(TicketB.this, HomeActivity.class);
        intent.putExtra("user", user);
        startActivity(intent);
        finish();
    }
    ...
    private void updateAllTicketReservationList() {
        DBHelper MyDB = new DBHelper(TicketB.this);
